...
NOME_PACOTE="COMPACTADORES"
PACOTE="p7zip-rar p7zip-full unace unrar zip unzip lzip sharutils rar arj cabextract file-roller uudeview mpack arc arj lhasa p7zip xz-utils zip"
